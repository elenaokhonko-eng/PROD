  ...
  <div style={{ fontFamily: "sans-serif", maxWidth: "600px", margin: "0 auto" }}>
    ...
    <div style={{ padding: "32px", backgroundColor: "#f9fafb" }}>
      ...
      <p style={{ fontSize: "16px", lineHeight: "1.6" }}>
        Thanks for creating your GuideBuoy AI account. This is just a confirmation?no action needed.
      </p>
      {hasRouterSession && (
        <div
          style={{
        ...
        >
          <p style={{ fontSize: "14px", margin: 0, fontWeight: "bold" }}>Your case assessment is saved</p>
          <p style={{ fontSize: "14px", margin: "8px 0 0 0" }}>
            We imported your complaint details. When you sign back in, you can continue where you left off.
          </p>
        </div>
      )}
      <p style={{ fontSize: "14px", color: "#6b7280", marginTop: "24px" }}>
        Need help? Reply to this email. We"re here if you get stuck.
      </p>
