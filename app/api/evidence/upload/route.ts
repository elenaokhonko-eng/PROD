...
export async function POST(request: Request) {
  try {
    ...
    // Build storage path — must match isValidEvidenceStoragePath: `{caseId}/{category}/{fileName}`
    ...
    // case_documents registration happens later via registerCaseDocumentFromEvidenceV1 on process.
