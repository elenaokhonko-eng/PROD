  ...
  switch (assessment.triage_path) {
    case "A":
      return {
        ...
        title: "Your case may have a framework to explore",
        description: `The Shared Responsibility Framework (SRF) may be relevant to your case with ${fi}. Review the framework and the institution's published process before deciding what to do next.`,
    ...
    case "A2":
      return {
        ...
        title: "A telco complaint route may be relevant",
        description:
          "Review IMDA&apos;s current complaint guidance and the facts of your situation before deciding whether to make a complaint.",
    ...
    case "E":
      return {
        ...
        title: "Consider the available options carefully",
        description:
          "For cryptocurrency and overseas platforms, available routes can vary. Check the receiving organisation&apos;s current guidance before taking action.",
        ctaText: "See my options",
