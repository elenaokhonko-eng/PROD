...
import { PendingNarrativeHandoff } from "@/components/pending-narrative-handoff"
import { QueryProvider } from "@/components/providers/query-provider"
import { RealtimeProvider } from "@/components/providers/realtime-provider"
import { ErrorBoundary } from "@/components/providers/error-boundary"
import { GroundingOverlay } from "@/components/sensory-mode/grounding-overlay"
import { GlobalModeDock } from "@/components/sensory-mode/global-mode-dock"
import { SensoryModeProvider } from "@/components/sensory-mode/sensory-mode-provider"

export const metadata: Metadata = {
  title: "GuideBuoy AI - Singapore's Complaint Helper",
  description:
    "Navigate scams and financial complaints with calm guidance. Lumi helps organise your account, evidence, and next steps.",
...
export default function RootLayout({
  ...
  return (
    <html lang="en" data-sensory="steady" suppressHydrationWarning>
      <head>
        <Script id="gb-sensory-mode-init" strategy="beforeInteractive">
          {`try{var m=localStorage.getItem('gb-sensory-mode');if(m==='steady'||m==='quiet'||m==='grounding'){document.documentElement.dataset.sensory=m}}catch(e){}`}
        </Script>
      </head>
            ...
            <QueryProvider>
              <RealtimeProvider>
                ...
                <Link
                  ...
                  className="fixed bottom-6 right-6 z-50 inline-flex h-12 w-12 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-ambient transition hover:bg-[var(--gb-primary-deep)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                >
                  ...
                  <div className="container mx-auto px-4 py-10 space-y-6">
                    <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between text-sm text-muted-foreground">
                      <div className="space-y-1">
                        <p className="font-medium text-foreground">GuideBuoy AI SG Pte Ltd © 2026</p>
                        <p>UEN: 202545875C</p>
                      ...
                      <div className="flex flex-wrap items-center gap-3 md:justify-end">
                        ...
                        <Link href="mailto:info@guidebuoyai.sg" className="hover:text-foreground">Email</Link>
