    ...
    <main className="flex min-h-screen items-center justify-center bg-background px-4 py-12">
      <section className="w-full max-w-md space-y-4">
        <div className="space-y-2 text-center">
          ...
          <h1 className="text-3xl font-semibold tracking-tight">Continue your case</h1>
          <p className="text-sm text-muted-foreground">Your saved story stays in this browser until you sign in.</p>
        </div>
